  ...
  return (
    <div className='landing-container'>
      <div className='landing-head'>
        ...
        <div class="p-2">
          <p>Check out a list of some of our intented features below:</p>
        </div>
        ...
        <div class="card">
          <div class="card-body">
              ...
              <p class="card-text">Create and manage your personal profile, customize your preferences, and keep track of your progress.</p>
            </div>
        </div>
        <div class="card">
          <div class="card-body">
              ...
              <p class="card-text">An integrated calendar feature to view your tasks at glance, helping you plan your schedule effectively</p>
            </div>
        </div>
        <div class="card">
          <div class="card-body">
              ...
              <p class="card-text">Stay organized by creating and managing your tasks, setting due dates, and tracking your progress.</p>
            </div>
        </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
              ...
              <p class="card-text">Track your academic progress over time, receive insights to improve your performance.</p>
            </div>
        </div>
        <div class="card">
          <div class="card-body">
              <h5 class="card-title">Dashboard Customization:</h5>
              
              <p class="card-text">Personalize your dashboard to display the information that matters most to you.</p>
            </div>
        </div>
        <div class="card">
          <div class="card-body">
              ...
              <p class="card-text">Calculate and monitor your grades, predict your GPA, and keep a close eye on your academic performance.</p>
            </div>
        </div>
      </div>
    </div>
